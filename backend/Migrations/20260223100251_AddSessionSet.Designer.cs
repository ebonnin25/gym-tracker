...
namespace backend.Migrations
{
    ...
    [Migration("20260223100251_AddSessionSet")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Domain.Entities.SessionExercise", b =>
                {
            ...
            modelBuilder.Entity("backend.Domain.Entities.SessionSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Domain.Entities.SessionSet", b =>
                {
                    b.HasOne("backend.Domain.Entities.SessionExercise", "SessionExercise")
                        .WithMany("Sets")
                        .HasForeignKey("SessionId", "ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
